...
expand_dets <-
  ...
  select(Repertory, Choreographer, Date, Length, num_dancers, Premiere, Music, Set,
         all_dates, costumes, lighting, Composer, play_url, premiere_place, `original cast`, photo_url, Description)
...
t <- reactable(
  ...
  columns = list(
    ...
    Music = colDef(minWidth=60, cell = function(value) {''}, align = "center", details = function(index) {
...
### table
# cell is bulleted list of dates performed
# filter by date, name, choreo, music
# no duplicate pieces
# fix formating of details for all relevant column
```
