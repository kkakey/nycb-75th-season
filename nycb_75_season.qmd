...
expand_dets <-
  ...
  transmute(
    ...
    Premiere = lubridate::mdy(premiere_date),
    premiere_place,
...
t <- reactable(
  ...
  columns = list(
    ...
    Premiere = colDef(
      ...
      format = colFormat(date = TRUE, separators = TRUE, locales = "en-US")
    ),
    Set = colDef(
      minWidth=60, 
      cell = function(value) {''}, 
