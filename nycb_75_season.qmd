...
<p class="footnote">This site is unofficial and unaffiliated with New York City Ballet. Photographs are sourced from New York City Ballet's official website, https://www.nycballet.com/, and the NYCB block letter logo are registered trademark of New York City Ballet, Inc.<br><br>Code and data [here](https://github.com/kkakey/nycb-75th-season) --- webpage created by @kkakey</p>
